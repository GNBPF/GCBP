...
export const SDG_GOALS: SDGGoal[] = [
  { id: 1, title: 'No Poverty', color: '#E5243B', imageUrl: '/SDGs/11.jpg' },
  { id: 2, title: 'Zero Hunger', color: '#DDA63A', imageUrl: '/SDGs/21.jpg' },
  { id: 3, title: 'Good Health and Well-Being', color: '#4C9F38', imageUrl: '/SDGs/31.jpg' },
  { id: 4, title: 'Quality Education', color: '#C5192D', imageUrl: '/SDGs/41.jpg' },
  { id: 5, title: 'Gender Equality', color: '#FF3A21', imageUrl: '/SDGs/51.jpg' },
  { id: 6, title: 'Clean Water and Sanitation', color: '#26BDE2', imageUrl: '/SDGs/61.jpg' },
  { id: 7, title: 'Affordable and Clean Energy', color: '#FCC30B', imageUrl: '/SDGs/71.jpg' },
  { id: 8, title: 'Decent Work and Economic Growth', color: '#A21942', imageUrl: '/SDGs/81.jpg' },
  { id: 9, title: 'Industry, Innovation and Infrastructure', color: '#FD6925', imageUrl: '/SDGs/91.jpg' },
  { id: 10, title: 'Reduced Inequalities', color: '#DD1367', imageUrl: '/SDGs/101.png' },
  { id: 11, title: 'Sustainable Cities and Communities', color: '#FD9D24', imageUrl: '/SDGs/111.jpg' },
  { id: 12, title: 'Responsible Consumption and Production', color: '#BF8B2E', imageUrl: '/SDGs/121.jpg' },
  { id: 13, title: 'Climate Action', color: '#3F7E44', imageUrl: '/SDGs/131.png' },
  { id: 14, title: 'Life Below Water', color: '#0A97D9', imageUrl: '/SDGs/141.jpg' },
  { id: 15, title: 'Life on Land', color: '#56C02B', imageUrl: '/SDGs/151.jpg' },
  { id: 16, title: 'Peace, Justice and Strong Institutions', color: '#00689D', imageUrl: '/SDGs/161.jpg' },
  { id: 17, title: 'Partnerships for the Goals', color: '#19486A', imageUrl: '/SDGs/171.jpg' },
];
