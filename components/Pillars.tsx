  ...
  return (
    <Section id="pillars" className="bg-ngo-sand">
       <div className="text-center max-w-3xl mx-auto mb-6 sm:mb-8 md:mb-10">
          <h2 className="font-serif text-xl sm:text-2xl md:text-3xl lg:text-4xl text-ngo-navy font-bold mb-2 sm:mb-3">Our Key Areas of Work</h2>
          <p className="font-sans text-ngo-gray text-xs sm:text-sm md:text-base px-4">
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6">
         {PILLARS.map((pillar, index) => (
           ...
           >
             ...
             <p className="font-sans text-ngo-gray text-xs sm:text-sm leading-relaxed mb-3">
               {pillar.description}
             </p>
             <span className="text-[8px] sm:text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-ngo-blue">
