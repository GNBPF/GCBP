...
export const HeroSection: React.FC = () => {
  return (
    <section className="pt-16 xs:pt-20 sm:pt-24 md:pt-28 lg:pt-32 pb-12 mobile-small:pb-16 xs:pb-18 sm:pb-20 px-4 mobile-small:px-5 xs:px-6 sm:px-8 md:px-12 lg:px-16">
