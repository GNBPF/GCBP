...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[500px] sm:min-h-[600px] lg:h-[80vh] w-full overflow-hidden flex flex-col justify-center">
      ...
      <div className="relative z-10 max-w-7xl mx-auto container-padding w-full pt-20 md:pt-24 lg:pt-16">
        <div className="max-w-3xl">
          ...
          >
            <span className="inline-block py-1 px-2 md:px-3 border border-white/30 rounded text-white/90 text-[10px] md:text-xs font-sans font-bold uppercase tracking-widest mb-3 md:mb-4 backdrop-blur-sm">
              Non-Profit Organization
            </span>
            <h1 className="font-serif text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-white font-bold leading-tight mb-3 md:mb-4 drop-shadow-md">
          ...
          <motion.p 
            className="font-sans text-sm sm:text-base md:text-lg text-white/90 leading-relaxed mb-6 md:mb-8 max-w-xl drop-shadow-sm"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <a href="#mission" className="px-5 md:px-6 py-2.5 md:py-3 bg-ngo-accent text-ngo-navy font-sans font-bold text-xs md:text-sm tracking-wide rounded hover:bg-white transition-colors duration-300 text-center">
              Our Projects
            </a>
            <a href="#join" className="px-5 md:px-6 py-2.5 md:py-3 bg-transparent border border-white text-white font-sans font-bold text-xs md:text-sm tracking-wide rounded hover:bg-white hover:text-ngo-navy transition-colors duration-300 text-center">
              Join the Collective
            </a>
          </motion.div>
        </div>
