...
export const HeroSection: React.FC = () => {
  return (
    <section className="relative bg-gcbp-primary h-[50vh] mobile-small:h-[55vh] min-h-[400px] mobile-small:min-h-[450px] xs:min-h-[500px] sm:min-h-[550px] max-h-[700px] flex items-center justify-center overflow-hidden pt-16 xs:pt-20 sm:pt-24 md:pt-28 lg:pt-32">
