      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 mobile-small:gap-8 xs:gap-10 sm:gap-12">
        ...
        <div>
          <div className="flex items-center gap-1.5 mobile-small:gap-2 mb-3 mobile-small:mb-4">
            <div className="footer-logo w-6 mobile-small:w-7 xs:w-8 h-6 mobile-small:h-7 xs:h-8 rounded-full bg-white text-gcbp-primary font-bold flex items-center justify-center text-[10px] mobile-small:text-xs xs:text-sm">GC</div>
